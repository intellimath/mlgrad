...
def whittaker_agg(X, aggfunc, func=None, func2=None, weights=None, h=0.01, 
              tau2=1.0, tau1=0, n_iter=1000, tol=1.0e-9, collect_qvals=False, n_iter2=100):
    ...
    U = func2.evaluate_array(self.Z - X)
